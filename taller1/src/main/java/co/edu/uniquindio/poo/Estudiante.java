...
public class Estudiante {
    ...
    public Estudiante(String name, String lastName, String ID, String mail, String phone, int age) {
        ...
        assert mail != null && mail.contains("@") : "El correo electrónico debe tener por lo menos un arroba (@) y no puede estar vacio";
        assert phone != null : "El telefono no puede ser nulo";
